...
TAGS = ["Halakhah","Talmud","Mishnah","Tanakh","Rashi","Rambam","Chasidut","Kabbalah",
        "Musar","Prayer","Tefillah","Shabbat","Pesach","Rosh Hashanah","Yom Kippur",
        "Sukkot","Chanukah","Purim","Shavuot","Parashat Hashavua","Women","Ethics",
        "Israel","Kashrut","Pirkei Avot","Zohar","Repentance","Charity","Prophets",
        "Marriage","Conversion","Death","Land of Israel","Jewish Thought","Midrash",
        "Halacha","Chumash","Holidays","Ten Commandments","Creation","Exodus","Moses",
        "Torah","Shema","Blessings","Sefer Torah"]
PER_TAG = 32
FR_WORKERS = 2   # gentle: at most 2 concurrent find-refs (ML) requests
...
def main():
    ...
    json.dump(allf, open(os.path.join(os.path.dirname(__file__), "v3_all_failures.json"), "w"), ensure_ascii=False, indent=0)
    json.dump(cands, open(os.path.join(os.path.dirname(__file__), "v3_candidates.json"), "w"), ensure_ascii=False, indent=0)
