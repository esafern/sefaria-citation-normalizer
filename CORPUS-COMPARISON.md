...
| **Absent works (the list)** | **72** | **73** | **+1** |
| **Absent citations** | **2,758** | **6,883** | **2.5×** |
| Tier 1 (public domain) | 22 | 23 | |
| Tier 2 (modern) | 50 | 50 | |

The corpus grew 2.6× but the **work count barely moved (72 → 73)**. The extra
...
6,883 absent citations** — a third of the entire demand signal, one beit midrash.
...
Public-domain tier (digitize, no licensing) is now **23 works / 1,051 citations**.
...
- **Noise / non-works** (5): `Dvar Charif` (the *concept* דבר חריף, all cited "9:3"),
  ...
  `Niddah Shiur`.
- **False-absent** (1): `Meiri Pesachim` → present as *Meiri on Pesachim*.
...
if it wants a free win, the 23-work public-domain tier.
